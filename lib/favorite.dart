...
class _favoriteState extends State<favorite> {
  ...
  List <plate> favoriteMeals=[
    plate(name: "Delciuse vegeterian", prix: 15, image: veg4),
    plate(name: "Healthy Food", prix: 15, image: veg2),
    plate(name: "vegeterian food", prix: 15, image: veg1),
    plate(name: "vegeterian food", prix: 15, image: veg3),
    plate(name: "vegeterian food", prix: 15, image: veg5),
  ];
  @override
                                    ...
                                    IconButton(
                                        ...
                                        onPressed: (){
                                          setState((){
                                            ...
                                            this.favoriteMeals[index].favicon = Icon(Icons.favorite_border,color:Colors.red, size: 36);
                                            
                                            }
                                            else{
                                            this.favoriteMeals[index].favicon = Icon(Icons.favorite,color:Colors.red, size: 36);
